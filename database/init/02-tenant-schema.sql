...
-- Note: TenantService's SchemaMigrator also creates prm_services on first request,
-- but we bootstrap it here so seed script 05 can INSERT immediately on container boot.
...
-- ============================================================
-- Tenant 1: aeroground_db
-- ============================================================
USE aeroground_db;

CREATE TABLE IF NOT EXISTS prm_services (
    row_id INT AUTO_INCREMENT PRIMARY KEY,
    id INT NOT NULL,  -- source-system PRM service ID; can repeat across rows when a service is paused/resumed
