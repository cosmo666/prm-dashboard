...
export class DashboardComponent implements OnInit, OnDestroy {
  ...
  /**
   * Filter-chip helpers — used by the active-filter pill row that lives
   * directly in this template (lifted out of FilterBar so the pills sit
   * at the dashboard's left edge instead of indented to where the
   * filter-bar component starts).
   */
